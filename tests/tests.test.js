...
describe('Returns an author who has written the most blogs', () => {
  ...
  test('List of six blogs, should return Robert C. Martin with 3 blogs', () => {
    ...
    const result = listHelper.authorWithTheMostBlogs(listWithSixBlogs)
    expect(result).toEqual({
      author: "Robert C. Martin",
      blogs: 3
    })
...
describe('Returns an author who has the most likes', () => {

  test('List of six blogs, should return Edsger W. Dijkstra with 17 likes', () => {
    const listWithSixBlogs = [
      {
        _id: "5a422a851b54a676234d17f7",
        title: "React patterns",
    ...
    const result = listHelper.authorWithTheMostLikes(listWithSixBlogs)
    // expect(result).toEqual({
    //   author: "Edsger W. Dijkstra",
    //   likes: 17
    // })
